...
- Pas de bouton "Précédent" (retour à l'étape 1 depuis l'étape 2) dans cette première version — l'ancien wizard n'en avait pas non plus (seulement "Fermer", qui annule tout), donc ce n'est pas une régression, juste une fonctionnalité non redemandée.
