...
class TrmdLine(TransientModel):
    ...
    _field_info = {
        ...
        "need_raw_duration_minutes": {"label": "Heures enseignées (besoin brut)", "type": "duration", "readOnly": True},
        "need_weighted_duration_minutes": {"label": "Heures pondérées (besoin)", "type": "duration", "readOnly": True},
        "are_duration_minutes": {"label": "ARE", "type": "duration", "readOnly": True},
        ...
        "def_teached_duration_minutes": {"label": "H. enseignées déf.", "type": "duration", "readOnly": True},
        "def_given_duration_minutes": {"label": "Heures données à un autre établissement déf.", "type": "duration", "readOnly": True},
        "def_gap_duration_minutes": {"label": "Écart ressources déf. - besoins déf.", "type": "duration", "readOnly": True},
        "temp_teacher_count": {"label": "Nb postes temp.", "type": "number", "readOnly": True},
        "temp_teached_duration_minutes": {"label": "H. enseignées temp.", "type": "duration", "readOnly": True},
        "temp_given_duration_minutes": {"label": "Heures données à un autre établissement temp.", "type": "duration", "readOnly": True},
        "total_ressource_duration_minutes": {"label": "Moyens totaux", "type": "duration", "readOnly": True},
        "total_gap_duration_minutes": {"label": "Ressource > besoin", "type": "duration", "readOnly": True},
        "total_hsa_duration_minutes": {"label": "HSA (Ressource < besoin)", "type": "duration", "readOnly": True},
        "imp_duration_minutes": {"label": "IMP", "type": "duration", "readOnly": True},
    }
