...
class TrmdLine(TransientModel):
    ...
    _field_info = {
        "discipline_id": {"label": "Discipline", "resource": "disciplines", "readOnly": True},
        "need_ids": {"label": "Besoins", "resource": "service_repartitions", "type": "multiselect", "readOnly": True},
        "def_teacher_ids": {"label": "Moyens définitifs", "resource": "teachers", "type": "multiselect", "readOnly": True},
        "temp_teacher_ids": {"label": "Moyens provisoires", "resource": "teachers", "type": "multiselect", "readOnly": True},
        "need_raw_duration_minutes": {"label": "Heures enseignées (besoin brut)", "readOnly": True},
        "need_weighted_duration_minutes": {"label": "Heures pondérées (besoin)", "readOnly": True},
        "are_duration_minutes": {"label": "ARE", "readOnly": True},
        "total_needs": {"label": "Besoins totaux", "readOnly": True},
        "def_teacher_count": {"label": "Nb postes déf.", "readOnly": True},
        "def_teached_duration_minutes": {"label": "H. enseignées déf.", "readOnly": True},
        "def_given_duration_minutes": {"label": "Heures données à un autre établissement déf.", "readOnly": True},
        "def_gap_duration_minutes": {"label": "Écart ressources déf. - besoins déf.", "readOnly": True},
        "temp_teacher_count": {"label": "Nb postes temp.", "readOnly": True},
        "temp_teached_duration_minutes": {"label": "H. enseignées temp.", "readOnly": True},
        "temp_given_duration_minutes": {"label": "Heures données à un autre établissement temp.", "readOnly": True},
        "total_ressource_duration_minutes": {"label": "Moyens totaux", "readOnly": True},
        "total_gap_duration_minutes": {"label": "Ressource > besoin", "readOnly": True},
        "total_hsa_duration_minutes": {"label": "HSA (Ressource < besoin)", "readOnly": True},
        "imp_duration_minutes": {"label": "IMP", "readOnly": True},
    }
