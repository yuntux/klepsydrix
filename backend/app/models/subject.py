...
class Subject(Base):
    ...
    short_label: Mapped[str] = mapped_column(String(30), nullable=False, info={"label": "Libellé court", "placeholder": "ex: Maths"})
    long_label: Mapped[str] = mapped_column(String(100), nullable=False, info={"label": "Libellé long", "placeholder": "ex: Mathématiques"})
